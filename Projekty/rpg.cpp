...
int main() {
  ...
  //b)
  cout << "\nb)\n";
  Przedmiot arr[2] = {Przedmiot("dzida", 65), Przedmiot("tarcza", 12)};
  ...
  //e)
  cout << "\ne)\n";
  cout <<"Przedmiot o najwiekszej obronie gracza 1: "<< b1.zwrocNajwiekszaObrone() <<endl;
  cout <<"Przedmiot o najwiekszej obronie gracza 2: "<< b2.zwrocNajwiekszaObrone() <<endl;
...
void Bohater::wyswietlBohatera(){
  cout << "Nazwa: " << imie << ", klasa: "<< klasa<<", punkty zycia: "<< punkty_zycia << ", ekwipunek:" <<endl;
